...
const RUNNABILITY_PROMPTS = [
  {
    ...
    thresholds: { firstDeltaMs: 4_000, totalMs: 45_000 }
  },
  {
    name: "warm turn 1",
    kind: "warm",
    ...
    reasoningEffort: "none",
    thresholds: { firstDeltaMs: 3_000, totalMs: 20_000 }
  },
  {
    name: "warm turn 2",
    kind: "warm",
...
function uiReadinessFromText(text) {
  ...
  const flags = {
    ...
    micReady: /Mic\s+(M ready|PTT ready|Ready|Connected|Available)/i.test(runtimeBlock),
